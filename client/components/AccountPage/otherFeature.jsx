  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <TouchableOpacity style={styles.button} onPress={() => handlePress('Thông tin cá nhân')}>
      ...
      <View style={styles.row}>
        ...
        <TouchableOpacity style={styles.button} onPress={() => handlePress('Số dư TK')}>
          <FontAwesome name="pencil" size={hp(2)}  style={styles.icon} />
          <Text style={styles.buttonText}>........</Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.row}>
        <TouchableOpacity style={styles.button} onPress={() => handlePress('Săn Thưởng ')}>
          <FontAwesome name="gift" size={hp(2)}  style={styles.icon} />
          <Text style={styles.buttonText}>.........</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.button} onPress={() => handlePress('Liên Kết')}>
