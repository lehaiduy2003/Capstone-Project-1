    ...
    <View style={styles.container}>
      ...
      <View style={styles.iconContainer}>
        <TouchableOpacity
          ...
          onPress={() => handleClick("Waiting for confirmation")}
        >
          <FontAwesome name="file" size={hp(3)} color={theme.colors.dark} />
          <Text style={styles.iconLabel}>Wait Confirm</Text>
        </TouchableOpacity>

        <TouchableOpacity style={styles.iconItem}
          onPress={() => handleClick("Waiting for goods")}
        >
          <FontAwesome name="shopping-basket" size={hp(3)} color={theme.colors.dark} />
        ...
        <TouchableOpacity
          style={styles.iconItem}
          onPress={() => handleClick("Waiting for delivery")}
        >
