      ...
      <View style={styles.modalOverlay}>
        <View style={styles.modalContainer}>
          ...
          <LottieView
            ...
            source={require("../../assets/animation/animation_check.json")}
            autoPlay
            loop />
          ...
          <Text style={styles.description}>
            Congratulations! Your account is already created. Please log in to get an amazing experience.
          </Text>
          ...
          <Button title="Go to Sign In" onPress={onClose} />
        </View>
      </View>
    </Modal>
  );
