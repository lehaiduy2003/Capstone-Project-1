...
class ProductRouter extends BaseRouter {
  ...
  public initRoutes(): void {
    ...
    this.router.get("/search", checkCache, this.productController.searchProducts.bind(this.productController));
    this.router.get("/:id", this.productController.getProductById.bind(this.productController));
    this.router.post("/", authenticateToken, this.productController.createProduct.bind(this.productController));
    this.router.patch("/:id", authenticateToken, this.productController.updateProductById.bind(this.productController));
    this.router.delete(
      "/:id",
      authenticateToken,
